             ...
             <div className="w-full">
               <div className="relative">
                 ...
                 <input
                   ...
                   className="w-full pl-10 pr-32 py-3 sm:py-4 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                 />
                 
                 {/* Upload and Analyze buttons inside search box */}
                 <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
                   <label className="flex items-center justify-center gap-1 px-2 py-1 bg-yellow-500/20 border border-yellow-500/30 text-yellow-400 rounded text-xs hover:bg-yellow-500/30 transition-colors cursor-pointer">
                   ...
                   <button
                     onClick={handleAudit}
                     disabled={loading}
                     className="flex items-center justify-center gap-1 px-3 py-1 bg-blue-500/20 border border-blue-500/30 text-blue-400 rounded text-xs hover:bg-blue-500/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                   >
                     {loading ? (
                     ...
                     <span className="hidden sm:inline">{loading ? "..." : "Audit"}</span>
                   </button>
                 </div>
               </div>
             </div>
